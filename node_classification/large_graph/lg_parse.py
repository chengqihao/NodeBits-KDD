from lg_model import GAT

def parse_method(args, n, c, d, device):
    model = GAT(d, args.hidden_channels, c, local_layers=args.local_layers,
            in_dropout=args.in_dropout, dropout=args.dropout,
            heads=args.num_heads, pre_ln=args.pre_ln,
            post_bn=args.post_bn, local_attn=args.local_attn,jk=args.jk).to(device)
    return model
